...
?>
<p>
	<label>Номер билета<br/>
	<input id="city" class="input" type="text" value="<?php echo $_POST['ticket']; ?>" name="ticket" /></label>
</p>
<?php };
	function init_setup() {
...
function init_scripts() {
	...
	wp_enqueue_script( 'library-jquery-js', get_template_directory_uri() . '/assets/js/jquery-3.3.1.min.js', array(), '20151215', true );
